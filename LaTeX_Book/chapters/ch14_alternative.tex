...
\subsection{The Scaling Site and Recent Developments (2018-present)}
...
\begin{theorem}[Connes-Consani Tropical Structure]
...
A key innovation is extending Riemann-Roch to almost periodic functions:

\begin{theorem}[Riemann-Roch for AP Functions]
\label{thm:rr_ap}
...
\section{Arithmetic Geometry and the Completion of Square (Wei Zhang)}
\label{sec:wei_zhang}
...
\begin{theorem}[Gross-Zagier Formula]
...
\begin{definition}[Arithmetic Completion of Square]
...
This perspective transforms the analytic question of L-function positivity into a geometric question about quadratic forms in arithmetic geometry.
...
\begin{theorem}[Zhang's Function Field Result]
...
\begin{conjecture}[Generalized Gross-Zagier]
...
\subsection{Connection to BSD and RH}
...
Fernando Rodriguez-Villegas and collaborators have developed a remarkable theory of hypergeometric motives (HGMs), providing a vast computational laboratory for L-functions with explicit formulas for all invariants \cite{rodriguez2018, roberts2021}.

\subsection{Definition and Construction}

\begin{definition}[Hypergeometric Motive]
\label{def:hgm}
...
\begin{algorithm}[Zigzag Procedure]
\label{alg:zigzag}
...
\begin{theorem}[Explicit Point Count Formula]
...
\begin{theorem}[p-adic Hypergeometric Functions]
\label{thm:padic_hgm}
