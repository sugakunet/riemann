...
\begin{theorem}[Davenport-Heilbronn Construction]
Define the function
\begin{equation}
...
\begin{theorem}[RMT-Zeta Connection]
...
\begin{theorem}[Spacing Statistics]
...
\begin{theorem}[Newman's Conjecture - Proved 2018]
$\Lambda \geq 0$.
\end{theorem}
