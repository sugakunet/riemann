...
\noindent\textbf{New Framework Needed}:
\begin{itemize}
...
\noindent\textbf{Candidates for Investigation}:
\begin{itemize}
...
\noindent\textbf{Accessible Goals}:
\begin{itemize}
...
\noindent\textbf{Specific Questions}:
\begin{itemize}
...
\noindent\textbf{Strategy Development}:
\begin{itemize}
...
\noindent\textbf{Fundamental Questions}:
\begin{itemize}
