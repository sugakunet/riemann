...
\begin{theorem}[Odlyzko-Schönhage Algorithm]
...
\begin{theorem}[Error Bounds in Riemann-Siegel]
...
\item Odlyzko found 1976 values where $|Z((γ_n + γ_{n+1})/2)| < 0.0005$
\end{itemize}
...
\begin{theorem}[Montgomery-Dyson Connection]
